...
Works on standard Linux distros and immutable Fedora-based distros (Bazzite, Bluefin, Aurora, etc.) where `dnf install` is not available. Also works with macOS Homebrew.
